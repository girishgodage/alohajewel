                ...
                <div className="wrap-login100">
                  <div className="login100-form validate-form">
                    ...
                    <div className="text-center p-t-115">
                      ...
                      <button className="txt2" onClick={this.goSignUp}>
                        Sign Up
                      </button>
                    </div>
                  </div>
                ...
                <div className="wrap-login100">
                  <div className="login100-form validate-form">
                    ...
                    <div className="text-center p-t-115">
                      ...
                      <button className="txt2" onClick={this.goLogIn}>
                        Log In
                      </button>
                    </div>
                  </div>
            ...
            <div className="wrap-login100">
              <div className="login100-form validate-form">
                ...
                <div className="container-login100-form-btn">
                  <div className="wrap-login100-form-btn">
                    <div className="login100-form-bgbtn"></div>
                    <Link to="/shop" className="login100-form-btn" id="goCart">
                      Shop
                    </Link>
                  </div>
                </div>
                ...
                <div className="container-login100-form-btn">
                  <div className="wrap-login100-form-btn">
                    <div className="login100-form-bgbtn"></div>
                    <Link to="/order" className="login100-form-btn" id="goCart">
                      Your Order
                    </Link>
                  </div>
                </div>
                ...
                <div className="text-center p-t-115">
                  <span className="txt1">Start browsing our product:</span>
